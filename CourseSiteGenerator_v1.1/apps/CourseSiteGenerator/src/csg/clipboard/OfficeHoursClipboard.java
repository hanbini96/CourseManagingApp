...
public class OfficeHoursClipboard implements AppClipboardComponent {
    ...
    public void cut() {
        ...
        if (data.isTASelected()) {
            ...
            CutTA_Transaction transaction = new CutTA_Transaction(app, clipboardCutTA, officeHours);
    ...
    public void paste() {
        ...
        if (clipboardCutTA != null) {
            PasteTA_Transaction transaction = new PasteTA_Transaction(app, clipboardCutTA);
            app.processTransaction(transaction);
            ...
            PasteTA_Transaction transaction = new PasteTA_Transaction(app, clipboardCopiedTA);
            app.processTransaction(transaction);
    ...
    public boolean hasSomethingToCut() {
        return (((CSGData)app.getDataComponent()).getOHData()).isTASelected();
    }
