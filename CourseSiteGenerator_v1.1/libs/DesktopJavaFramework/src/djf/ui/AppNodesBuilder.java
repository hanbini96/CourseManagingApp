...
public class AppNodesBuilder {
    ...
    public ImageView buildIcon(Object nodeId,
            GridPane parent,
            int col, int row, int colSpan, int rowSpan,
            String styleClass,
            boolean enabled) {
        ...
        initNode(nodeId, image, parent, col, row, colSpan, rowSpan, styleClass, enabled);

        // AND RETURN THE COMPLETED BUTTON
        return image;
    }
    public ImageView buildIcon(String imagePath, Object nodeId,
            GridPane parent,
            int col, int row, int colSpan, int rowSpan,
            String styleClass,
            boolean enabled) {
        // NOW MAKE THE TOGGLE BUTTON
        Image imageBase = new Image(FILE_PROTOCOL+imagePath, 50, 0, true, true);
        ImageView image = new ImageView(imageBase);
        initNode(nodeId, image, parent, col, row, colSpan, rowSpan, styleClass, enabled);

        // AND RETURN THE COMPLETED BUTTON
        return image;
    }
    public void setIcon(ImageView image, String imagePath){
        image.setImage(null);
        Image imageBase = new Image(FILE_PROTOCOL+imagePath, 200, 0, true, true);
    ...
    public ChoiceBox buildChoiceBox(Object nodeId,
            Pane parentPane,
            String styleClass,
            boolean enabled) {
        // NOW MAKE THE TABLE VIEW
        ...
        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, choiceBox, parentPane, styleClass, enabled);
    ...
    public ChoiceBox buildChoiceBox(Object nodeId,
        ...
        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, choiceBox, parent, col, row, colSpan, rowSpan, styleClass, enabled);
    ...
    public TabPane buildTabPane(Object nodeId,
            ...
            String styleClass,
            boolean enabled) {
        // NOW MAKE THE TAB PANE
        TabPane tableView = new TabPane();
    ...
    public DatePicker buildDatePicker(Object nodeId,
        ...
        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, dp, parentPane, col, row, colSpan, rowSpan, styleClass, enabled);
        return dp;
    }
}